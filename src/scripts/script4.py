...
if __name__ == '__main__':
    ...
    clfs = [RandomForestClassifier(n_estimators=200, n_jobs=-1, criterion='gini', class_weight='balanced'),
            RandomForestClassifier(n_estimators=100, n_jobs=-1, criterion='entropy', class_weight='balanced'),
            ExtraTreesClassifier(n_estimators=100, n_jobs=-1, criterion='gini', class_weight='balanced'),
            ExtraTreesClassifier(n_estimators=100, n_jobs=-1, criterion='entropy', class_weight='balanced'),
...
#            clf.fit(X_train, y_train)
    ...
    submission.to_csv("submission_2xRF2xETGB005.csv", index=False)
